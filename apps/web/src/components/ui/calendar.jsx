...
/**
 * Componente de calendario personalizado para DayLog
 * 
 * Este componente proporciona un calendario interactivo basado en react-day-picker
 * con estilos personalizados que se integran con el sistema de diseño de DayLog.
 * Incluye navegación entre meses, selección de fechas y soporte para rangos.
 * 
 * @param {Object} props - Propiedades del componente
 * @param {string} [props.className=''] - Clases CSS adicionales
 * @param {Object} [props.classNames] - Clases CSS personalizadas para diferentes partes del calendario
 * @param {boolean} [props.showOutsideDays=true] - Si mostrar días fuera del mes actual
 * @param {Object} [props.components] - Componentes personalizados para el calendario
 * @param {React.Ref} ref - Referencia forwardRef
 * @returns {JSX.Element} El componente Calendar renderizado
 * 
 * @example
 * // Calendario básico
 * <Calendar />
...
function Calendar({
  ...
  /**
   * Configuración por defecto de las clases CSS para el calendario
   * Define el estilo visual de todos los elementos del calendario
   */
  const defaultClassNames = {
    months: "relative flex flex-col sm:flex-row gap-4",
    month: "w-full",
    month_caption: "relative mb-1 flex h-9 items-center justify-center z-20",
  ...
  /**
   * Combina las clases por defecto con las clases personalizadas proporcionadas
   */
  ...
  /**
   * Componentes por defecto para la navegación del calendario
   */
  ...
  /**
   * Combina los componentes por defecto con los componentes personalizados
   */
