...
const mainMenuItems = [
  ...
  {
    title: 'Empleados',
    to: '/supervisor/empleados',
    icon: Users,
  },
  {
    title: 'Proyectos',
    to: '/supervisor/proyectos',
    icon: Folder,
  },
  {
    title: 'Permisos',
    to: '/supervisor/permisos',
...
export default function NavbarSupervisor({ isExpanded: expandedProp = false, onExpandChange }) {
                  ...
                  <div>
                    ...
                    {!isSmallScreen && (
                      <>
                        ...
                        <span className="ml-2 text-s text-gray-400 font-medium">Supervisor</span>
                      </>
                    )}
                  </div>
                )}
