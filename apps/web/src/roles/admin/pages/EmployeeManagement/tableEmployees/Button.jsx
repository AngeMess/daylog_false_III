...
const buttonVariants = ({ variant, size, className }) => {
  ...
  const variants = {
    ...
    outline: "border border-[#01426A] bg-transparent text-[#01426A] hover:bg-[#01426A]/10",
    secondary: "bg-[#FFC600] text-[#01426A] hover:bg-[#FFC600]/90",
    ghost: "hover:bg-slate-100 hover:text-[#01426A]",
    link: "text-[#01426A] underline-offset-4 hover:underline",
    ...
    btn_g: "!add-button !flex !items-center !gap-2 !py-2 !px-4 !bg-[#F2F2F2] !text-[#5A5A5A] !font-medium !rounded-md !transition-all !duration-300 !border !border-transparent hover:!bg-[#CCCCCC] !shadow-sm hover:!shadow-md !w-full",
  };
...
const Button = React.forwardRef(
  ({ className, variant, size, children, ...props }, ref) => { // Se agregó 'children' a los props
    return (
      <button
        ...
        {...props}
      >
        {children} {/* Se renderizan los children aquí */}
      </button>
    )
  }
);
