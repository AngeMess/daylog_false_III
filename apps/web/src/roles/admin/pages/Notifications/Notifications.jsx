...
export default function Notifications() {
  ...
  const handleActionClick = (notification) => {
    ...
    if (notification.projectId) {
      navigate(`/admin/proyectos/detalle-proyecto/${notification.projectId}`);
    }
  };

  // Añadir función para eliminar todas las notificaciones leídas
  ...
  // Verificar si hay notificaciones leídas
    ...
    <div>
      ...
      <div className="mt-6 mb-4 flex justify-between items-center">
        ...
        {notifications.length > 0 && (
          <div className="flex gap-3 ml-auto"> {/* ml-auto empuja a la derecha */}
            <button 
      ...
      {/* El botón de marcar como leídas se movió arriba */}
    </div>
  );
}
