...
export default function Navbar({ isExpanded: expandedProp = false, onExpandChange }) {
                    ...
                    <div>
                      ...
                      {!isSmallScreen && (
                        <>
                          ...
                          <span className="ml-2 text-s text-gray-400 font-medium">Admin</span>
                        </>
                      )}
                    </div>
                  )}
