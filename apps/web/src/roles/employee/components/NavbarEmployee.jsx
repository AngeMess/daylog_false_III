...
const mainMenuItems = [
  ...
  {
    title: 'Proyectos',
    to: '/employee/proyectos',
    icon: Folder,
  },
  {
    title: 'Permisos',
    to: '/employee/permisos',
    icon: FileSpreadsheet,
  },
  {
    title: 'Mi rendimiento',
    to: '/employee/rendimiento',
    icon: TrendingUp,
  },
  {
    title: 'Notificaciones',
    to: '/employee/notificaciones',
    icon: Bell,
  },
  {
    title: 'Cerrar sesión',
...
export default function NavbarEmployee({ isExpanded: expandedProp = false, onExpandChange }) {
          ...
          <div className="flex items-center">
            {!isExpanded && !isSmallScreen ? (
              <div className="w-12 h-12 flex items-center justify-center">
                <img src="/bancocuscatlan.svg" alt="DayLog" className="w-8 h-8" />
              </div>
            ) : (
              <div className="flex items-center">
                <img src="/bancocuscatlan.svg" alt="DayLog" className="w-8 h-8 mr-3" />
                {(isExpanded || isSmallScreen) && (
                  <div>
                    ...
                    {!isSmallScreen && (
                      <>
                        ...
                        <span className="ml-2 text-s text-gray-400 font-medium">Empleado</span>
                      </>
                    )}
                  </div>
                )}
              ...
              return (
                <li key={index}>
                  <NavLink
                    ...
                    className={({ isActive }) => {
                      // Nunca marcar como activo el botón de cerrar sesión
                  ...
                  >
                    {({ isActive }) => {
                      // Si es el botón de cerrar sesión, solo mostrarlo como activo cuando se ha hecho clic
